...
Interrupt number space. 0-15 are reserved and always deliverable; 16-63 are user interrupts, delivered only while unmasked (__builtin_sti()). See Ceres-C docs/10-Interrupts.md and CeresASM docs/08-Interrupts-and-Exceptions.md.
