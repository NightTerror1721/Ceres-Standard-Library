...
Fixed-size blocks with allocation and release in constant time: entities, bullets, particles. Free blocks form a list threaded through their own first four bytes, so a block is at least 4 bytes and is rounded up to a multiple of 4 to stay aligned.
