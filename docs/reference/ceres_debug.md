...
Logging and inspection for programs under development. Everything goes to the terminal through printf, so it interleaves correctly with the program's own output.
