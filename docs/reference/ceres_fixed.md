...
16.16 fixed-point arithmetic, for games that want exact, repeatable numbers without the float unit. A fixed_t is a signed 32-bit integer holding value * 65536: the range is about -32768.0 .. 32767.99998 and the step is 1/65536.
