...
A set kept as a sorted vector of keys, searched by bisection - ceres/ds/flatmap.h with no value, for the same reason ceres/ds/hset.h exists next to ceres/ds/gmap.h.
