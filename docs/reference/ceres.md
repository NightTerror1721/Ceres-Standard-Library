...
Ceres reaches its devices through memory-mapped I/O at the top of the address space (see CeresASM docs/07-IO-Devices-and-Ports.md). These are the addresses the terminal and the system-control device live at.
