...
// A linear allocator: allocation is a pointer bump, and everything is released at once (or back to a
// mark). Suited to memory with one lifetime - a frame, a level, a parse.
