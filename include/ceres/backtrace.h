...
//
// Every function that calls another keeps a frame: [fp] is the caller's fp and [fp + 4] the address it
// returns to (CeresASM docs/24-Calling-Convention.md), so the callers are a chain of frames from fp up. A
