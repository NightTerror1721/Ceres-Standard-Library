...
// classic "fast" LZ4) and uses a 16 KiB table of the library's.
//
...
// linked or independent, compressed or stored; its checksums are skipped rather than checked.
//
...
#define LZ4_BOUND(n) ((n) + (n) / 255u + 16u)    // the most lz4_compress can write for n bytes
