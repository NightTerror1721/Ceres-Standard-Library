...
// Key codes. The host pushes SDL3 scancodes straight into the keyboard device, and SDL3 scancodes
// are USB HID usage codes: A is 4, Enter is 40, the up arrow is 82. Without a window (plain
// `ceres run`) the keyboard device receives nothing and input arrives through the terminal instead
// (see ceres/input.h, input_terminal_fallback).
//
