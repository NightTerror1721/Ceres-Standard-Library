...
// 2D and 3D vectors passed and returned by value, and the small numeric helpers games keep rewriting.
// It is vecmath.h, not vec.h, so it cannot be mistaken for ceres/ds/vector.h (the growable array).
