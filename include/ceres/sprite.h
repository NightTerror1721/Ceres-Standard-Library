...
// Sprites (images with one transparent colour), frame animation, tile maps with a camera, and the
// rectangle tests that games need for collisions. Pixel data is the caller's: a sprite only points at it,
// so a sprite can live in .rodata.
