...
// A priority queue: a binary min-heap of fixed-size elements ordered by a comparison function. Push and
// pop cost O(log n). Used for shortest-path search, timers and schedulers.
//
