...
int    memcmp(const void* a, const void* b, size_t n);   // unsigned bytes, like the standard says
...
int    strcmp(const char* a, const char* b);             // unsigned comparison
int    strncmp(const char* a, const char* b, size_t n);
int    strcoll(const char* a, const char* b);            // the "C" locale: same as strcmp
